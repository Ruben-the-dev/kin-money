...
Si vous souhaitez explorer le code ou faire tourner le projet sur votre machine :

1️⃣ **Cloner le projet**
git clone https://github.com/Ruben-the-dev/kin-money.git cd kin-money


2️⃣ **Préparer l'environnement**
Installez toutes les dépendances nécessaires (FastAPI, SQLAlchemy, Uvicorn, etc.) :
...
Une fois lancé, l'application est accessible sur : 👉 `http://127.0.0.1:8000`

---

## 🛡️ Note sur la Sécurité
Pour cette version de démonstration, les accès ont été simplifiés. Dans un projet réel, j'utilise des **Variables d'Environnement**, le hachage des mots de passe et une authentification via **Tokens JWT**.

---

## 💬 On reste en contact ?
Je réalise ce type de solutions en **Freelance**. Si vous avez un projet en tête ou si vous voulez simplement échanger sur l'architecture backend et le DevOps, n'hésitez pas :
